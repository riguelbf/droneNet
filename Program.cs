...
using Algorithm.Logic.Application;
using Algorithm.Logic.Application.Services;
...
namespace Algorithm.Logic
{
    ...
    public class Program
    {
        ...
        public Program()
        {
            AppDomain.CurrentDomain.UnhandledException += ExceptionFilter.UnhandledExceptionTrapper;
        }

        public static string Evaluate(string input)
        {
            return new DroneServiceApplication().GetCoordinate(input);
        }
    }
}
